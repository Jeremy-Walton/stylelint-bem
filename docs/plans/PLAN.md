...
- **Open items:**
  ...
  - **Phase 2 done (2026-07-21):** `validName` + `noDoubleNestedElement`, implemented — see the Phase 2 section for the full shape. Next up: Phase 3 (`requireNesting`, "the big one"), once Jeremy reviews Phases 1.5–2.
